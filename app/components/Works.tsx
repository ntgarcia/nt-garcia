...
const k2lollaImages = [
  "/design/knock2/k2-lolla-back.jpg",
  "/design/knock2/k2-lolla-front.jpg",
];
...
const holblImages = [
  "/design/hol/bl_pash_front.jpg",
  "/design/hol/bl_pash_back.png",
];
...
const projects: Project[] = [
...

  {
    ...
    slug: "isoxo-ftsu-merch",
    height: 320,
    title: "Iso FTSU Merch",
    tags: [],
    type: "slideshow",
  ...
  // {
  //   id: 8,
  //   imageUrl: "/design/hol/bl_pash_front.jpg",
  //   slug: "hol_bl_pash",
  //   height: 320,
  //   title: "HOL! Born Loud Pash",
  //   tags: [],
  //   type: "slideshow",
  //   slideshowImages: holblImages,
  // },

  // {
  //   id: 9,
  //   imageUrl: "/design/hol/BL_COLLAGE_BIG.png",
  //   slug: "bl_collage",
  //   height: 320,
  //   title: "HOL! BORN LOUD",
  //   tags: [],
  ...
  // {
  //   id: 6,
  //   imageUrl: "/design/knock2/k2-lolla-back.jpg",
  //   slug: "knock2-lolla-flyer",
  //   height: 320,
  //   title: "Knock2 Lolla Merch",
  //   tags: [],
  //   type: "slideshow",
  //   slideshowImages: k2lollaImages,
  // },
      ...
      if (project.slideshowImages) {
        return (
          <div className="relative w-full rounded-lg overflow-hidden border border-zinc-200">
            <ImageLoop images={project.slideshowImages} />
          </div>
        );
      }
        ...
        <div className="relative w-full overflow-hidden rounded-lg">
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(to top, rgba(0,0,0,0.9) 0%, rgba(0,0,0,0.6) 20%, rgba(0,0,0,0.3) 40%, rgba(0,0,0,0) 70%)",
              }}
            >
              {/* Progressive blur container with mask and @supports rule */}
              <style jsx>{`
                @supports (
                  (-webkit-backdrop-filter: blur(12px)) or
              ...
              <div
                ...
                style={{
                  maskImage:
                    "linear-gradient(to top, rgba(0,0,0,1) 0%, rgba(0,0,0,0.98) 5%, rgba(0,0,0,0.95) 10%, rgba(0,0,0,0.85) 20%, rgba(0,0,0,0.5) 40%, rgba(0,0,0,0.1) 60%, rgba(0,0,0,0) 70%)",
                  WebkitMaskImage:
                    "linear-gradient(to top, rgba(0,0,0,1) 0%, rgba(0,0,0,0.98) 5%, rgba(0,0,0,0.95) 10%, rgba(0,0,0,0.85) 20%, rgba(0,0,0,0.5) 40%, rgba(0,0,0,0.1) 60%, rgba(0,0,0,0) 70%)",
                }}
              />
...
export default function Works() {
  ...
  return (
    <section
      id="works"
      className=" py-10 md:py-20 px-4 md:px-8 relative"
    >
